...
//   make?: string | null;
//   model?: string | null;
//   trim?: string | number | null;
//   odometer_amount: string | null;
//   odometer_status: string | null;
//   body: string | null;
//   drivetrain: string | null;
//   drivetrain_desc: string | null;
//   engine_cylinders: number | null;
//   engine_liters: number | null;
//   engine_desc: string | null;
//   fuel: string | null;
...
//   constructor(public props: CarProps, route: string) {
...
//   get name(): string {
//     const { stock, year, make, model } = this.props;
//     return `${stock} ${year} ${make} ${model}`;
//   }

//   get stock(): number | undefined {
//     return this.props.stock ? this.props.stock : undefined;
//   }
...
//     return this.props.year ? this.props.year : undefined;
//   }
...
//   get trim(): string | number | undefined {
